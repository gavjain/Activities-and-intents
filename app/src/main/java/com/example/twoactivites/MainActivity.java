...
import com.example.twoactivites.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void launchSecondActivity(View view) {
        ...
        Intent intent = new Intent(this, com.example.twoactivites.SecondActivity.class);
    ...
    ActivityResultLauncher<Intent> secondActivityResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
        ...
        public void onActivityResult(ActivityResult result) {
            if (result.getResultCode() == Activity.RESULT_OK) {
                ...
                String reply = data.getStringExtra(com.example.twoactivites.SecondActivity.EXTRA_REPLY);
